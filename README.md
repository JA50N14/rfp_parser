  ...
  - Year (i.e. "2025", "2026", etc.)
    - Business Unit (i.e. "Facilities Management", etc.)
      - Division (i.e. "FM East", "FM West", etc.)
        - RFP Packages - Where your RFP Packages are located. Each directory need to represent a RFP Package. Within the Package, there can be as many sub-folders documents as needed. 
...
6. Create a .env file. Within the .env file add the following variables:
