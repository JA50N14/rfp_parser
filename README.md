...
2. Create a Smartsheet with the following columns (in this order): Date Parsed, RFP Package Name, KPI Name, KPI Category, KPI Context
3. Create a directory on your file system. Within this root directory, place all RFP Packages that need to be parsed (each folder represents a RFP Package).
