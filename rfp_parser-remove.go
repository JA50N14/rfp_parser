...
// 	wbData := make(map[string][][]string) //Second Problem - Puts the entire workbook into a map struct. Now you have 2 versions of the workbook in memory simtaneously.
