...
6. In parser/kpiDefinitions.json, update this file to include the KPI's you would like to parse for inside of docx and xlsx files
7. In main.go, update the "RfpPackageRootDir" const variable to the location of the root directory created in step #3
8. Run program from this applications root directory: go run ./ Year Business Unit
